...
This is main Terraform code base to create demo of autoscaling environment in Oracle Cloud Infrastructure using Terraform 0.12.
...
Events Rule with autoscaling and instance events which then uses the Notification topic to send information.
